...
import com.fzxt.exception.CustomerException;
import com.fzxt.exception.ExceptionCast;
...
public class QQAuthServiceImpl extends DefaultAuthServiceImpl implements QQAuthService {
    ...
    public String getAccessToken(String code) {
        ...
        if(resp.contains("access_token")){
            ...
            throw new CustomerException(StatusCode.ACCESSTOKENERR);
        }
    }
    ...
    public String getOpenId(String accessToken) {
        ...
        if(resp.contains("openid")){
            ...
            throw new CustomerException(StatusCode.OPENTIDERR);
        }
    }
